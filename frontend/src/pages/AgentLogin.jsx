...
import './CustomerLogin.css'; // Reusing the same CSS for now
    ...
    return (
        <div className="login-body">
            ...
            <div className="login-box">
                ...
                <p className="subtitle">PICKUP AGENT LOGIN</p>
                ...
                <div className="register">
                    First time agent? <Link to="/agent/register">Register Here</Link>
                </div>
